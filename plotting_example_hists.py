...
infile = ROOT.TFile.Open("example_histograms.root","READ")
histos = []
legendLines = []

histo1 = infile.Get("Eff_Eta")
# This is a silly memory management thing you have
# to do for histograms so they no longer belong
# to the input file. histos don't need it.
histo1.SetDirectory(0)
histos.append(histo1)
legendLines.append("#eta")

histo2 = infile.Get("Eff_Phi")
histo2.SetDirectory(0)
histos.append(histo2)
legendLines.append("#phi")
...
for histo, line in zip(histos,legendLines) :
  ...
  # Label my axes!!
  histo.GetXaxis().SetTitle("Track #eta or #phi")
...
c.SaveAs("plot_hists.eps")
c.SaveSource("plot_hists.C")
c.SaveSource("plot_hists.root")
